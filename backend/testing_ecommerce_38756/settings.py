"""
Django settings for testing_ecommerce_38756 project.
...
ROOT_URLCONF = 'testing_ecommerce_38756.urls'
...
WSGI_APPLICATION = 'testing_ecommerce_38756.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testing_ecommerce_38756 API",
    "DESCRIPTION": "API documentation for testing_ecommerce_38756 App",
    "VERSION": "v1",
}
